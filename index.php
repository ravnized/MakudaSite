                ...
                <div class="container" id="containerText">
                    <div class="textOverlay" id="textOverlay">
                        <h2 class="is-size-1" id="weAre">
                            WE ARE
                            <img alt="Makuda" class="makuda-logo" src="media/img/Logo_PNG_Negativo-2-1024x94.png" />
                        </h2>
...
foreach ($parsed as $view) {
    ...
    <section class="section">
        <div class="container fade-in-animation" id="logos-carousel">
            <div class="carousel" data-autoplay="true" data-infinite="true" data-navigation="false"
                data-slidesToShow="7" id="carousel3">
    ...
    <script crossorigin="anonymous"
        ...
        src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.5.1/TextPlugin.min.js"></script>
    ...
    <script crossorigin="anonymous"
        ...
        src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.5.1/PixiPlugin.min.js"></script>
