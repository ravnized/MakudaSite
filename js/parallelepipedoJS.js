$(document).ready(function ($) {
    ...
    if($(window).width() > 1024){
        ...
        parallelepipedo.click(function (e) {
            ...
            let number = $(this).find(".numberParallelepipedo");
            let counter = 0;
            Array.prototype.forEach.call(parallelepipedo, element=>{
                timelineAfter = gsap.timeline();
                if(disable[counter]){
                    disable[counter] = false;
                    timelineAfter.to(
                        $(parallelepipedParent[counter]).find(".square"),
                        {
                            duration: 0.2,
                            opacity: 0,
                            width: 0,
                    ...
                    timelineAfter.to(
                        $(parallelepipedParent[counter]).find(".textInsideSquare"),
                        {
                            duration: 0.5,
                            opacity: 0,
                            ease: "power2.in",
                    ...
                    timelineAfter.to(
                        $(parallelepipedParent[counter]).find(".secondText"),
                        {
                            duration: 0.5,
                            translateY: 680,
                            ease: "power2.in",
                    ...
                    timelineAfter.to(
                        $(parallelepipedParent[counter]).find(".numberParallelepipedo"),
                        {
                            opacity: 1,
                            color: "#4a4a4a",
                            duration: 0.1,
                    ...
                    timelineAfter.to(
                        $(parallelepipedParent[counter]).find(".parallelepipedo"),
                        {
                            duration: 0.5,
                            background: "linear-gradient(#3b3b3b,#3b3b3b)",
                        },
