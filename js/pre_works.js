...
$("<style>.makuda-home-link--works:before{width: 100%}</style>").appendTo(
  "head"
);
$("<style>.makuda-home-link--contacts:before{width: 100%}</style>").appendTo(
  "head"
);
...
function video1Enter() {
  if (isFinished) {
    ...
    tl.to($(".mask"), { duration: 0.5, width: "25%" }, "filterAnimation");
    tl.to(
      $("#video1"),
      {
        duration: 1,
...
function video2Enter() {
  if (isFinished) {
    ...
    tl.to($(".mask"), { duration: 0.5, width: "75%" }, "filterAnimation");
...
function animationStart() {
  if ($(window).width() > 1025) {
    ...
    $("#mainSection").on("mouseleave", function () {
      ...
      tl.to($(".mask"), { duration: 0.5, width: "50%" }, "filterAnimation");
    });
  }
