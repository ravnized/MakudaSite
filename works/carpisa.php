                ...
                <div class="workBlock">
                  <div class="workBlockImageSub">
                    <div class="container is-max-desktop">
                      ...
                      >
                        <source
                          src="../media/video/works/carpisa.mp4"
                          type="video/mp4"
                        />
                        <p class="vjs-no-js">
              ...
              <div class="container textContainer">
                <div class='singleWorkBlockTitle'>
                  <p class="titleVideo noWrap">
                    <?=$view["title"]?>
                    <span class="subTitleVideo makuda-color" style="font-size:0.5em;"><?=$view["subtitle"]?></span>
                  </p>
                </div>
        ...
        <div class="gif-cellulari columns" data-animated="true">
          <div class="column">
            <video
              id="video1"
              autoplay
              class="imageVideo video-js vjs-default-skin vjs-16-9 gif-cellulare"
              data-setup='{"controls":true}'
              loop
              muted
              preload="none"
            >
              <source
                src="/media/video/works/carpisa_cellulare_1.mp4"
                type="video/mp4"
              />
              <p class="vjs-no-js">
                To view this video please enable JavaScript, and
          ...
          <video
            ...
            >
              <source
                src="/media/video/works/carpisa_cellulare_3.mp4"
                type="video/mp4"
              />
              <p class="vjs-no-js">
                To view this video please enable JavaScript, and
          ...
          <video
            ...
            >
              <source
                src="/media/video/works/carpisa_cellulare_2.mp4"
                type="video/mp4"
              />
              <p class="vjs-no-js">
                To view this video please enable JavaScript, and
